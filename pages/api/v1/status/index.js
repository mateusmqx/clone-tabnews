...
async function status(request, response) {
    ...
    const datbaseVersionResult = await database.query("SHOW server_version;");
    const datbaseVersionValue = datbaseVersionResult.rows[0].server_version;
